...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-soft hover:bg-sage-dark active:scale-[0.98]",
        destructive:
        ...
        // Custom Ayurvedic variants
        cta: "bg-primary text-primary-foreground shadow-elevated hover:bg-sage-dark active:scale-[0.98] font-semibold tracking-wide",
        whatsapp:
          "bg-[#25D366] text-white shadow-elevated hover:bg-[#20BA5C] active:scale-[0.98] font-semibold",
        terracotta:
          "bg-terracotta text-white shadow-soft hover:bg-terracotta/90 active:scale-[0.98]",
